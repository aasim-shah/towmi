            ...
            <div className="w-10/12 gap-3 mx-auto flex flex-col sm:flex-row">
                <div className="bgClr w-full rounded-[1.3rem] p-5">
                    <div className="w-[10rem] mx-auto h-[10rem]" >
                        <Image className='w-full h-full' src={"/Ambulance.svg"} width={500} height={400} />
                    </div>
                ...
                <div className="bgClr w-full rounded-[1.3rem] p-5">
                    <div className="w-[10rem] mx-auto h-[10rem]" >
                        <Image className='w-full h-full' src={"/pngwing 1.svg"} width={500} height={400} />
                    </div>
                ...
                <div className="bgClr w-full rounded-[1.3rem] p-5">
                    <div className="w-[10rem] mx-auto h-[10rem]" >
                        <Image className='w-full h-full' src={"/truck.svg"} width={500} height={400} />
                    </div>
