    ...
    <div className='  bgClr pt-10    w-full '>
      ...
      <div className="w-11/12 sm:w-9/12  mx-auto  justify-between  flex flex-col sm:flex-row ">
        <div className="flex  sm:w-7/12 flex-col  justify-evenly">
          ...
          <p className="text-white  text-lg leading-[2.5rem] sm:text-[28px] sm:font-[600] ">Ready to redefine your emergency assistance experience?</p>
          <p className="text-white mt-4  text-sm sm:text-lg ">Download Towmi now and drive with confidence on Nigeria &rsquo;s roads! 🌐🚦</p>

          <div className="flex w-11/12   sm:w-5/12 gap-4 2xl:w-4/12  mt-10 sm:mt-0 justify-between flex-row">
